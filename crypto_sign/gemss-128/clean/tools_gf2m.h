...
#define isEqual_gf2m(a,b) PQCLEAN_GEMSS128_CLEAN_ISEQUAL(a,b,NB_WORD_GF2m)
...
#define isEqual_nocst_gf2m CONCAT(CONCAT_NB_WORD_GF2m_SUP(PQCLEAN_GEMSS128_CLEAN_ISEQUAL),_NOCST)
