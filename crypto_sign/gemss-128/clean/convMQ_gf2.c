 ...
 */
void PQCLEAN_GEMSS128_CLEAN_convMQ_UL_gf2(uint8_t *pk2, const uint8_t *pk) {
 ...
 * @remark  Constant-time implementation.
 */
UINT PQCLEAN_GEMSS128_CLEAN_convMQ_last_uncompressL_gf2(uint64_t *pk2, const uint8_t *pk) {
 ...
 * @remark  Constant-time implementation.
 */
UINT PQCLEAN_GEMSS128_CLEAN_convMQ_uncompressL_gf2(uint64_t *pk2, const uint8_t *pk) {
    const uint8_t *pk64;
    unsigned int iq, ir, k, nb_bits;
    uint64_t t1, t2;
