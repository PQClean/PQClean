...
#define firstStepHFE_gf2nx(l,i,poly,poly2,F,U)     /* X^(2^n) - X mod (F-U) */    l=best_frobeniusMap_HFE_gf2nx(poly,F,U);    /* Initialize to F */    PQCLEAN_GEMSS128_AVX2_convHFEpolynomialSparseToDense_gf2nx(poly2,F);    /* Initialize to F-U */    add2_gf2n(poly2,U);    (l)=PQCLEAN_GEMSS128_AVX2_gcd_gf2nx(&(i),poly2,d2,poly,l);
