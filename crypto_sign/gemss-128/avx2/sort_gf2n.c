 ...
 */
void PQCLEAN_GEMSS128_AVX2_quickSort_nocst_gf2n(vec_gf2n tab_start, vec_gf2n tab_last) {
    vec_gf2n pivot, end;
    ...
    if (pivot < tab_last) {
        PQCLEAN_GEMSS128_AVX2_quickSort_nocst_gf2n(pivot, tab_last);
    }
    tab_last += NB_WORD_GFqn;
    if (tab_last < end) {
        PQCLEAN_GEMSS128_AVX2_quickSort_nocst_gf2n(tab_last, end);
    }
}
 ...
 */
void PQCLEAN_GEMSS128_AVX2_selectionSort_nocst_gf2n(vec_gf2n tab, int l) {
 ...
 */
void PQCLEAN_GEMSS128_AVX2_fast_sort_gf2n(vec_gf2n tab, int l) {
 ...
 */
void PQCLEAN_GEMSS128_AVX2_selectionSort_gf2n(vec_gf2n tab, int l) {
