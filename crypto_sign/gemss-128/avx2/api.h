...
#define PQCLEAN_GEMSS128_AVX2_CRYPTO_ALGNAME                      "gemss-128"

#define PQCLEAN_GEMSS128_AVX2_CRYPTO_SECRETKEYBYTES               16
...
int PQCLEAN_GEMSS128_AVX2_crypto_sign(uint8_t *sm, size_t *smlen, const uint8_t *msg, size_t len, const uint8_t *sk);
int PQCLEAN_GEMSS128_AVX2_crypto_sign_open(uint8_t *m, size_t *mlen, const uint8_t *sm, size_t smlen, const uint8_t *pk);
