...
void PQCLEAN_GEMSSRED192_CLEAN_rem_gf2n_ref(static_gf2n P[NB_WORD_GFqn],
        cst_static_gf2x Pol[NB_WORD_MUL]);
void PQCLEAN_GEMSSRED192_CLEAN_remsqr_gf2n_ref(static_gf2n P[NB_WORD_GFqn],
        cst_static_gf2x Pol[NB_WORD_MUL]);

void PQCLEAN_GEMSSRED192_CLEAN_rem_gf2n_ref2(static_gf2n P[NB_WORD_GFqn],
        cst_static_gf2x Pol[NB_WORD_MUL]);
...
/* Faster */
#define rem_gf2n PQCLEAN_GEMSSRED192_CLEAN_rem_gf2n_ref2

/* Choice of the best rem when the input is a square */
#define remsqr_gf2n PQCLEAN_GEMSSRED192_CLEAN_remsqr_gf2n_ref
