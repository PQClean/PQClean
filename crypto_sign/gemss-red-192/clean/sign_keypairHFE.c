 ...
 */
int PQCLEAN_GEMSSRED192_CLEAN_sign_keypairHFE(uint8_t *pk, UINT *sk) {
    mqsnv_gf2n Q;
    ...
    F = sk_uncomp;
    PQCLEAN_GEMSSRED192_CLEAN_cleanMonicHFEv_gf2nx(F);
    ...
    PQCLEAN_GEMSSRED192_CLEAN_invMatrixLUnv_gf2(S, L, U);
    ...
    PQCLEAN_GEMSSRED192_CLEAN_invMatrixLUn_gf2(T, L, U);
