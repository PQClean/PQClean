...
void PQCLEAN_GEMSSRED192_CLEAN_convMQS_one_eq_to_hybrid_rep8_comp_gf2(uint8_t *pk2,
    ...
    for (j = 0; j < HFEmr8; ++j) {
        PQCLEAN_GEMSSRED192_CLEAN_convMQ_UL_gf2(pk2 + ACCESS_last_equations8 + j * NB_BYTES_EQUATION,
 ...
 * PQCLEAN_GEMSSRED192_CLEAN_convMQS_one_eq_to_hybrid_rep8_comp_gf2 when N mod 8 = 0 (the last byte of
...
void PQCLEAN_GEMSSRED192_CLEAN_convMQS_one_eq_to_hybrid_rep8_uncomp_gf2(uint8_t *pk2,
    ...
    val = PQCLEAN_GEMSSRED192_CLEAN_convMQ_last_UL_gf2(pk2 + ACCESS_last_equations8
