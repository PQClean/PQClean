 ...
 */
void PQCLEAN_GEMSSRED192_AVX2_genCanonicalBasis_gf2n(vec_gf2n alpha_vec) {
    vec_gf2n a_vec;
    unsigned int i, j;
...
/**
 * @brief   Compute the transpose of the matrix built by PQCLEAN_GEMSSRED192_AVX2_genCanonicalBasis_gf2n:
 ...
 * @remark  Ths matrix can be precomputed once n is fixed.
 */
void PQCLEAN_GEMSSRED192_AVX2_genCanonicalBasisVertical_gf2n(vec_gf2n alpha_vec) {
    unsigned int i;
    unsigned int j;
