 ...
 */
unsigned int PQCLEAN_GEMSSRED192_AVX2_frobeniusMap_HFE_gf2nx(gf2nx Xqn, const
    ...
    for (i = HFEDegI + 1; i < HFEn; ++i) {
        ...
        PQCLEAN_GEMSSRED192_AVX2_sqr_HFE_gf2nx(Xqn);
 ...
 * @remark  Constant-time implementation.
 */
unsigned int PQCLEAN_GEMSSRED192_AVX2_frobeniusMap_multisqr_HFE_gf2nx(gf2nx Xqn, const
        complete_sparse_monic_gf2nx F, cst_gf2n U) {
    static_gf2n cst[NB_WORD_GFqn];
    static_gf2n mul_coef[NB_WORD_GFqn];
    gf2nx Xqn_cp;
