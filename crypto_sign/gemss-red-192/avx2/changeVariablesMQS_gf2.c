 ...
 */
int PQCLEAN_GEMSSRED192_AVX2_changeVariablesMQS_simd_gf2(mqsnv_gf2n MQS, cst_GLnv_gf2 S) {
 ...
 * @return   0 if the result is correct, ERROR_ALLOC for error from
 * malloc/calloc functions.
 * @remark  This function should be faster than PQCLEAN_GEMSSRED192_AVX2_changeVariablesMQS_simd_gf2
 * when SIMD is not used.
 * @remark  Constant-time implementation.
 */
int PQCLEAN_GEMSSRED192_AVX2_changeVariablesMQS64_gf2(mqsnv_gf2n MQS, cst_GLnv_gf2 S) {
    mqsnv_gf2n MQS2, MQS2_cp;
    UINT bit_kr, mask;
    cst_mqsnv_gf2n MQS_cpi, MQS_cpj;
    cst_GLnv_gf2 S_cpi, S_cpj;
