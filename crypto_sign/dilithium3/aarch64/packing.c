...
**************************************************/
void pack_pk(uint8_t pk[PQCLEAN_DILITHIUM3_AARCH64_CRYPTO_PUBLICKEYBYTES],
...
**************************************************/
void pack_sig(uint8_t sig[PQCLEAN_DILITHIUM3_AARCH64_CRYPTO_BYTES],
...
int unpack_sig(uint8_t c[CTILDEBYTES],
               polyvecl *z,
               polyveck *h,
               const uint8_t sig[PQCLEAN_DILITHIUM3_AARCH64_CRYPTO_BYTES]) {
    unsigned int i, j, k;
