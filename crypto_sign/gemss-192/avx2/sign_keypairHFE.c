 ...
 */
int PQCLEAN_GEMSS192_AVX2_sign_keypairHFE(uint8_t *pk, UINT *sk) {
    mqsnv_gf2n Q;
    ...
    F = sk_uncomp;
    PQCLEAN_GEMSS192_AVX2_cleanMonicHFEv_gf2nx(F);
    ...
    PQCLEAN_GEMSS192_AVX2_invMatrixLUnv_gf2(S, L, U);
    ...
    PQCLEAN_GEMSS192_AVX2_invMatrixLUn_gf2(T, L, U);
