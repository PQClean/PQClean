...
*/
void PQCLEAN_GEMSSBLUE256_CLEAN_vecMatProductnv_64(vecn_gf2 res, cst_vecn_gf2 vec, cst_Mn_gf2 S) {
    cst_Mn_gf2 S_cp;
    UINT bit_ir, vec_ir;
    unsigned int iq, ir;
...
void PQCLEAN_GEMSSBLUE256_CLEAN_vecMatProductnvn_64(vecn_gf2 res, cst_vecn_gf2 vec, cst_Mn_gf2 S) {
    cst_Mn_gf2 S_cp;
    UINT bit_ir, vec_ir;
    unsigned int iq, ir;
...
void PQCLEAN_GEMSSBLUE256_CLEAN_vecMatProductv_64(vecn_gf2 res, cst_vecn_gf2 vec, cst_Mn_gf2 S) {
    cst_Mn_gf2 S_cp;
    UINT bit_ir, vec_ir;
    unsigned int iq, ir;
...
void PQCLEAN_GEMSSBLUE256_CLEAN_vecMatProductn_64(vecn_gf2 res, cst_vecn_gf2 vec, cst_Mn_gf2 S) {
    cst_Mn_gf2 S_cp;
    UINT bit_ir, vec_ir;
    unsigned int iq, ir;
...
void PQCLEAN_GEMSSBLUE256_CLEAN_vecMatProductm_64(vecn_gf2 res, cst_vecn_gf2 vec, cst_Mn_gf2 S) {
    cst_Mn_gf2 S_cp;
    UINT bit_ir, vec_ir;
    unsigned int iq, ir;
...
void PQCLEAN_GEMSSBLUE256_CLEAN_vecMatProductnvn_start_64(vecn_gf2 res, cst_vecn_gf2 vec, cst_Mn_gf2 S, unsigned int start) {
    cst_Mn_gf2 S_cp;
    UINT bit_ir, vec_ir;
    unsigned int iq, ir;
