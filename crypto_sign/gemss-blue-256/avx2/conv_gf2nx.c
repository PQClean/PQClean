 ...
 */
void PQCLEAN_GEMSSBLUE256_AVX2_convMonic_gf2nx(gf2nx F, unsigned int d) {
 ...
 */
void PQCLEAN_GEMSSBLUE256_AVX2_convHFEpolynomialSparseToDense_gf2nx(gf2nx F_dense,
