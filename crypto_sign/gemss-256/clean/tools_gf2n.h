...
#define isEqual_gf2n(a,b) PQCLEAN_GEMSS256_CLEAN_ISEQUAL(a,b,NB_WORD_GFqn)
#define is0_gf2n(a) PQCLEAN_GEMSS256_CLEAN_ISZERO(a,NB_WORD_GFqn)
#define isNot0_gf2n(a) PQCLEAN_GEMSS256_CLEAN_ISNOTZERO(a,NB_WORD_GFqn)
#define is1_gf2n(a) PQCLEAN_GEMSS256_CLEAN_ISONE(a,NB_WORD_GFqn)
#define cmp_lt_gf2n(a,b) PQCLEAN_GEMSS256_CLEAN_CMP_LT(a,b,NB_WORD_GFqn)
#define cmp_gt_gf2n(a,b) PQCLEAN_GEMSS256_CLEAN_CMP_GT(a,b,NB_WORD_GFqn)
...
#define isEqual_nocst_gf2n CONCAT(CONCAT_NB_WORD_GFqn_SUP(PQCLEAN_GEMSS256_CLEAN_ISEQUAL),_NOCST)
#define cmp_lt_nocst_gf2n CONCAT(CONCAT_NB_WORD_GFqn_SUP(PQCLEAN_GEMSS256_CLEAN_CMP_LT),_NOCST)
