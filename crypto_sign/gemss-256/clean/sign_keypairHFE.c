 ...
 */
int PQCLEAN_GEMSS256_CLEAN_sign_keypairHFE(uint8_t *pk, UINT *sk) {
    mqsnv_gf2n Q;
    ...
    F = sk_uncomp;
    PQCLEAN_GEMSS256_CLEAN_cleanMonicHFEv_gf2nx(F);
    ...
    PQCLEAN_GEMSS256_CLEAN_invMatrixLUnv_gf2(S, L, U);
    ...
    PQCLEAN_GEMSS256_CLEAN_invMatrixLUn_gf2(T, L, U);
