...
void PQCLEAN_GEMSS256_AVX2_mul_no_simd_gf2x_ref(uint64_t C[NB_WORD_MUL],
...
void PQCLEAN_GEMSS256_AVX2_mul_then_rem_gf2n(uint64_t res[NB_WORD_GFqn], const uint64_t A[NB_WORD_GFqn], const uint64_t B[NB_WORD_GFqn]);
...
#define mul_gf2n PQCLEAN_GEMSS256_AVX2_mul_then_rem_gf2n
