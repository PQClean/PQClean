 ...
 */
void PQCLEAN_GEMSS256_AVX2_convMQ_UL_gf2(uint8_t *pk2, const uint8_t *pk) {
 ...
 * @remark  Constant-time implementation.
 */
uint64_t PQCLEAN_GEMSS256_AVX2_convMQ_last_UL_gf2(uint8_t *pk2, const uint8_t *pk) {
    uint64_t val;
    unsigned int i, k, nb_bits;
    int j;
 ...
 * are missing (cf. the output of PQCLEAN_GEMSS256_AVX2_convMQ_last_UL_gf2). Moreover, the last byte
