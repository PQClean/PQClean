...
uint64_t PQCLEAN_GEMSS256_AVX2_sqr32_no_simd_gf2x(uint64_t A);
uint64_t PQCLEAN_GEMSS256_AVX2_sqr64low_no_simd_gf2x(uint64_t A);
...
uint64_t PQCLEAN_GEMSS256_AVX2_psqr64low_gf2x(uint64_t A);
void PQCLEAN_GEMSS256_AVX2_psqr64_gf2x(uint64_t C[2], const uint64_t A[1]);
void PQCLEAN_GEMSS256_AVX2_psqr96_gf2x(uint64_t C[3], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_psqr128_gf2x(uint64_t C[4], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_psqr160_gf2x(uint64_t C[5], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_psqr192_gf2x(uint64_t C[6], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_psqr224_gf2x(uint64_t C[7], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_psqr256_gf2x(uint64_t C[8], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_psqr288_gf2x(uint64_t C[9], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_psqr320_gf2x(uint64_t C[10], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_psqr352_gf2x(uint64_t C[11], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_psqr384_gf2x(uint64_t C[12], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_psqr416_gf2x(uint64_t C[13], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_psqr448_gf2x(uint64_t C[14], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_psqr480_gf2x(uint64_t C[15], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_psqr512_gf2x(uint64_t C[16], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_psqr544_gf2x(uint64_t C[17], const uint64_t A[9]);
void PQCLEAN_GEMSS256_AVX2_psqr576_gf2x(uint64_t C[18], const uint64_t A[9]);

#define psqr32_gf2x PQCLEAN_GEMSS256_AVX2_psqr64low_gf2x
...
uint64_t PQCLEAN_GEMSS256_AVX2_psqr64low_shuffle_gf2x(uint64_t A);
void PQCLEAN_GEMSS256_AVX2_psqr64_shuffle_gf2x(uint64_t C[2], const uint64_t A[1]);
void PQCLEAN_GEMSS256_AVX2_psqr96_shuffle_gf2x(uint64_t C[3], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_psqr128_shuffle_gf2x(uint64_t C[4], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_psqr160_shuffle_gf2x(uint64_t C[5], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_psqr192_shuffle_gf2x(uint64_t C[6], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_psqr224_shuffle_gf2x(uint64_t C[7], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_psqr256_shuffle_gf2x(uint64_t C[8], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_psqr288_shuffle_gf2x(uint64_t C[9], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_psqr320_shuffle_gf2x(uint64_t C[10], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_psqr352_shuffle_gf2x(uint64_t C[11], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_psqr384_shuffle_gf2x(uint64_t C[12], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_psqr416_shuffle_gf2x(uint64_t C[13], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_psqr448_shuffle_gf2x(uint64_t C[14], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_psqr480_shuffle_gf2x(uint64_t C[15], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_psqr512_shuffle_gf2x(uint64_t C[16], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_psqr544_shuffle_gf2x(uint64_t C[17], const uint64_t A[9]);
void PQCLEAN_GEMSS256_AVX2_psqr576_shuffle_gf2x(uint64_t C[18], const uint64_t A[9]);


#define psqr32_shuffle_gf2x PQCLEAN_GEMSS256_AVX2_psqr64low_shuffle_gf2x
...
uint64_t PQCLEAN_GEMSS256_AVX2_vpsqr64low_shuffle_gf2x(uint64_t A);
void PQCLEAN_GEMSS256_AVX2_vpsqr64_shuffle_gf2x(uint64_t C[2], const uint64_t A[1]);
void PQCLEAN_GEMSS256_AVX2_vpsqr96_shuffle_gf2x(uint64_t C[3], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_vpsqr128_shuffle_gf2x(uint64_t C[4], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_vpsqr160_shuffle_gf2x(uint64_t C[5], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_vpsqr192_shuffle_gf2x(uint64_t C[6], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_vpsqr224_shuffle_gf2x(uint64_t C[7], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_vpsqr256_shuffle_gf2x(uint64_t C[8], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_vpsqr288_shuffle_gf2x(uint64_t C[9], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_vpsqr320_shuffle_gf2x(uint64_t C[10], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_vpsqr352_shuffle_gf2x(uint64_t C[11], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_vpsqr384_shuffle_gf2x(uint64_t C[12], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_vpsqr416_shuffle_gf2x(uint64_t C[13], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_vpsqr448_shuffle_gf2x(uint64_t C[14], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_vpsqr480_shuffle_gf2x(uint64_t C[15], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_vpsqr512_shuffle_gf2x(uint64_t C[16], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_vpsqr544_shuffle_gf2x(uint64_t C[17], const uint64_t A[9]);
void PQCLEAN_GEMSS256_AVX2_vpsqr576_shuffle_gf2x(uint64_t C[18], const uint64_t A[9]);

#define vpsqr32_shuffle_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr64low_shuffle_gf2x
...
uint64_t PQCLEAN_GEMSS256_AVX2_sqr64low_pclmul_gf2x(uint64_t A);
void PQCLEAN_GEMSS256_AVX2_sqr64_pclmul_gf2x(uint64_t C[2], const uint64_t A[1]);
void PQCLEAN_GEMSS256_AVX2_sqr96_pclmul_gf2x(uint64_t C[3], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_sqr128_pclmul_gf2x(uint64_t C[4], const uint64_t A[2]);
void PQCLEAN_GEMSS256_AVX2_sqr160_pclmul_gf2x(uint64_t C[5], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_sqr192_pclmul_gf2x(uint64_t C[6], const uint64_t A[3]);
void PQCLEAN_GEMSS256_AVX2_sqr224_pclmul_gf2x(uint64_t C[7], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_sqr256_pclmul_gf2x(uint64_t C[8], const uint64_t A[4]);
void PQCLEAN_GEMSS256_AVX2_sqr288_pclmul_gf2x(uint64_t C[9], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_sqr320_pclmul_gf2x(uint64_t C[10], const uint64_t A[5]);
void PQCLEAN_GEMSS256_AVX2_sqr352_pclmul_gf2x(uint64_t C[11], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_sqr384_pclmul_gf2x(uint64_t C[12], const uint64_t A[6]);
void PQCLEAN_GEMSS256_AVX2_sqr416_pclmul_gf2x(uint64_t C[13], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_sqr448_pclmul_gf2x(uint64_t C[14], const uint64_t A[7]);
void PQCLEAN_GEMSS256_AVX2_sqr480_pclmul_gf2x(uint64_t C[15], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_sqr512_pclmul_gf2x(uint64_t C[16], const uint64_t A[8]);
void PQCLEAN_GEMSS256_AVX2_sqr544_pclmul_gf2x(uint64_t C[17], const uint64_t A[9]);
void PQCLEAN_GEMSS256_AVX2_sqr576_pclmul_gf2x(uint64_t C[18], const uint64_t A[9]);

#define sqr32_pclmul_gf2x PQCLEAN_GEMSS256_AVX2_sqr64low_pclmul_gf2x
...
/* #define best_sqr64low_gf2x PQCLEAN_GEMSS256_AVX2_sqr64low_pclmul_gf2x */
/* #define best_sqr64_gf2x PQCLEAN_GEMSS256_AVX2_sqr64_pclmul_gf2x */
#define best_sqr96_gf2x PQCLEAN_GEMSS256_AVX2_sqr96_pclmul_gf2x
#define best_sqr128_gf2x PQCLEAN_GEMSS256_AVX2_sqr128_pclmul_gf2x
#define best_sqr160_gf2x PQCLEAN_GEMSS256_AVX2_sqr160_pclmul_gf2x
#define best_sqr192_gf2x PQCLEAN_GEMSS256_AVX2_sqr192_pclmul_gf2x
#define best_sqr224_gf2x PQCLEAN_GEMSS256_AVX2_sqr224_pclmul_gf2x

/* Faster on Haswell */
#define best_sqr256_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr256_shuffle_gf2x
#define best_sqr288_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr288_shuffle_gf2x
#define best_sqr320_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr320_shuffle_gf2x
#define best_sqr352_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr352_shuffle_gf2x
#define best_sqr384_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr384_shuffle_gf2x
#define best_sqr416_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr416_shuffle_gf2x
#define best_sqr448_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr448_shuffle_gf2x
#define best_sqr480_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr480_shuffle_gf2x
#define best_sqr512_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr512_shuffle_gf2x
#define best_sqr544_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr544_shuffle_gf2x
#define best_sqr576_gf2x PQCLEAN_GEMSS256_AVX2_vpsqr576_shuffle_gf2x
