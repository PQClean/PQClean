 ...
 */
int PQCLEAN_GEMSSBLUE128_CLEAN_sign_keypairHFE(uint8_t *pk, UINT *sk) {
    ...
    F = sk_uncomp;
    PQCLEAN_GEMSSBLUE128_CLEAN_cleanMonicHFEv_gf2nx(F);
    ...
    PQCLEAN_GEMSSBLUE128_CLEAN_invMatrixLUnv_gf2(S, L, U);
    ...
    PQCLEAN_GEMSSBLUE128_CLEAN_invMatrixLUn_gf2(T, L, U);
