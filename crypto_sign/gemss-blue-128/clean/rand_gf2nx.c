 ...
 * d is not secret.
 */
void PQCLEAN_GEMSSBLUE128_CLEAN_randMonic_gf2nx(gf2nx F, unsigned int d) {
...
void PQCLEAN_GEMSSBLUE128_CLEAN_cleanMonicHFE_gf2nx(sparse_monic_gf2nx F) {
 ...
 */
void PQCLEAN_GEMSSBLUE128_CLEAN_randMonicHFE_gf2nx(sparse_monic_gf2nx F) {
    /* Random generation of each coefficient excepted for the leading term */
...
void PQCLEAN_GEMSSBLUE128_CLEAN_cleanMonicHFEv_gf2nx(sparse_monic_gf2nx F) {
    cst_sparse_monic_gf2nx F_end;
 ...
 * @remark  Constant-time implementation when randombytes is constant-time.
 */
void PQCLEAN_GEMSSBLUE128_CLEAN_randMonicHFEv_gf2nx(sparse_monic_gf2nx F) {
    /* Random generation of each coefficient excepted for the leading term */
