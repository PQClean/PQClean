...
void PQCLEAN_GEMSSBLUE128_AVX2_randInvMatrix_gf2_n(GLn_gf2 S, Mn_gf2 S_cp) {
    ...
    do {
        PQCLEAN_GEMSSBLUE128_AVX2_randMatrix_gf2_n(S);
...
void PQCLEAN_GEMSSBLUE128_AVX2_randInvMatrix_gf2_nv(GLnv_gf2 S, Mnv_gf2 S_cp) {
    ...
    do {
        PQCLEAN_GEMSSBLUE128_AVX2_randMatrix_gf2_nv(S);
...
void PQCLEAN_GEMSSBLUE128_AVX2_cleanLowerMatrixnv(Tn_gf2 L) {
    UINT mask;
    unsigned int iq, ir;
 ...
 * @remark  Constant-time implementation.
 */
void PQCLEAN_GEMSSBLUE128_AVX2_genLowerMatrixnv(Tn_gf2 L) {
    UINT mask;
    unsigned int iq, ir;
 ...
 * @remark  Constant-time implementation.
 */
void PQCLEAN_GEMSSBLUE128_AVX2_mulMatricesLU_gf2_nv(Mn_gf2 S, cst_Tn_gf2 L, cst_Tn_gf2 U) {
    cst_Tn_gf2 L_cp, U_cp;
    UINT tmp;
    unsigned int iq, ir, jq, jr, k, mini;
