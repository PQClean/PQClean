...
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT2_NOCST(a,b) (((a)[1]==(b)[1])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT1_NOCST(a,b)                                              :((a)[1]<(b)[1]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT3_NOCST(a,b) (((a)[2]==(b)[2])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT2_NOCST(a,b)                                              :((a)[2]<(b)[2]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT4_NOCST(a,b) (((a)[3]==(b)[3])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT3_NOCST(a,b)                                              :((a)[3]<(b)[3]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT5_NOCST(a,b) (((a)[4]==(b)[4])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT4_NOCST(a,b)                                              :((a)[4]<(b)[4]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT6_NOCST(a,b) (((a)[5]==(b)[5])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT5_NOCST(a,b)                                              :((a)[5]<(b)[5]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT7_NOCST(a,b) (((a)[6]==(b)[6])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT6_NOCST(a,b)                                              :((a)[6]<(b)[6]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT8_NOCST(a,b) (((a)[7]==(b)[7])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT7_NOCST(a,b)                                              :((a)[7]<(b)[7]))
#define PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT9_NOCST(a,b) (((a)[8]==(b)[8])?PQCLEAN_GEMSSBLUE128_AVX2_CMP_LT8_NOCST(a,b)                                              :((a)[8]<(b)[8]))
