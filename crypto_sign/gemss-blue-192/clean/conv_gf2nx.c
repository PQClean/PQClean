 ...
 */
void PQCLEAN_GEMSSBLUE192_CLEAN_convMonic_gf2nx(gf2nx F, unsigned int d) {
 ...
 */
void PQCLEAN_GEMSSBLUE192_CLEAN_convHFEpolynomialSparseToDense_gf2nx(gf2nx F_dense,
