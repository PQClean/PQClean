...
void PQCLEAN_GEMSSBLUE192_CLEAN_mul_no_simd_gf2x_ref(uint64_t C[NB_WORD_MUL],
...
#define mul_gf2x PQCLEAN_GEMSSBLUE192_CLEAN_mul_no_simd_gf2x_ref
...
void PQCLEAN_GEMSSBLUE192_CLEAN_mul_then_rem_gf2n(uint64_t res[NB_WORD_GFqn], const uint64_t A[NB_WORD_GFqn], const uint64_t B[NB_WORD_GFqn]);
...
#define mul_gf2n PQCLEAN_GEMSSBLUE192_CLEAN_mul_then_rem_gf2n
