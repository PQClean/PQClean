 ...
 */
int PQCLEAN_GEMSSBLUE192_AVX2_genSecretMQS_gf2_ref(mqsnv_gf2n MQS, cst_sparse_monic_gf2nx F) {
    ...
    PQCLEAN_GEMSSBLUE192_AVX2_genCanonicalBasis_gf2n(alpha_vec);
 ...
 * @remark  Constant-time implementation.
 */
int PQCLEAN_GEMSSBLUE192_AVX2_genSecretMQS_gf2_opt(mqsnv_gf2n MQS, cst_sparse_monic_gf2nx F) {
    ...
    PQCLEAN_GEMSSBLUE192_AVX2_genCanonicalBasisVertical_gf2n(alpha_vec);
