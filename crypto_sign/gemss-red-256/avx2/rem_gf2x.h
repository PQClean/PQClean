...
#define MACRO_128_TRINOMIAL_GF2X(ROW1,ROW2,P,Pol,k3,ki,Q,R,mask)     /* x^k = x^k3 + 1 */    ROW1;    ROW2;    /* x^k = 1 */    XOR2(P,Pol,Q);    /* x^k = x^k3 */    (P)[0]^=(Q)[0]<<(k3);    (P)[1]^=((Q)[0]>>(64-(k3)))^((Q)[1]<<(k3));    /* x^k = x^k3 + 1 */    if ((ki)>=(k3)) (R)=(Q)[1]>>((ki)-(k3));    else (R)=((Q)[0]>>(64-((k3)-(ki))))^((Q)[1]<<((k3)-(ki)));    /* x^k = 1 */    (P)[0]^=(R);    /* x^k = x^k3 */    (P)[0]^=(R)<<(k3);    (P)[1]&=(mask);
...
#define MACRO_192_TRINOMIAL_GF2X(ROW,P,Pol,k3,ki,ki64,k364,Q,R,mask)     (Q)[0]=((Pol)[2]>>(ki))^((Pol)[3]<<(ki64));    (Q)[1]=((Pol)[3]>>(ki))^((Pol)[4]<<(ki64));    ROW;    XOR3(P,Pol,Q);    (P)[0]^=(Q)[0]<<(k3);    (P)[1]^=((Q)[0]>>(k364))^((Q)[1]<<(k3));    (P)[2]^=((Q)[1]>>(k364))^((Q)[2]<<(k3));    /* 64-((k364)+(ki)) == ((k3)-(ki)) */    if ((ki)>=(k3)) (R)=(Q)[2]>>((ki)-(k3));    else (R)=((Q)[1]>>((k364)+(ki)))^((Q)[2]<<((k3)-(ki)));    (P)[0]^=(R);    (P)[0]^=(R)<<(k3);    (P)[2]&=(mask);
