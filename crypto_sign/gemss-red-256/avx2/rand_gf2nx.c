 ...
 * d is not secret.
 */
void PQCLEAN_GEMSSRED256_AVX2_randMonic_gf2nx(gf2nx F, unsigned int d) {
...
void PQCLEAN_GEMSSRED256_AVX2_cleanMonicHFE_gf2nx(sparse_monic_gf2nx F) {
 ...
 */
void PQCLEAN_GEMSSRED256_AVX2_randMonicHFE_gf2nx(sparse_monic_gf2nx F) {
    /* Random generation of each coefficient excepted for the leading term */
...
void PQCLEAN_GEMSSRED256_AVX2_cleanMonicHFEv_gf2nx(sparse_monic_gf2nx F) {
    cst_sparse_monic_gf2nx F_end;
 ...
 * @remark  Constant-time implementation when randombytes is constant-time.
 */
void PQCLEAN_GEMSSRED256_AVX2_randMonicHFEv_gf2nx(sparse_monic_gf2nx F) {
    /* Random generation of each coefficient excepted for the leading term */
