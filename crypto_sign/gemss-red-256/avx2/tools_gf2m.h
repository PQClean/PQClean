...
#define isEqual_gf2m(a,b) PQCLEAN_GEMSSRED256_AVX2_ISEQUAL(a,b,NB_WORD_GF2m)
...
#define isEqual_nocst_gf2m CONCAT(CONCAT_NB_WORD_GF2m_SUP(PQCLEAN_GEMSSRED256_AVX2_ISEQUAL),_NOCST)
