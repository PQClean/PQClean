 ...
 */
void PQCLEAN_GEMSSRED256_AVX2_inv_Fermat_gf2n_ref(uint64_t res[NB_WORD_GFqn],
 ...
 */
void PQCLEAN_GEMSSRED256_AVX2_inv_ITMIA_gf2n_ref(static_gf2n res[NB_WORD_GFqn],
...
void PQCLEAN_GEMSSRED256_AVX2_inv_ITMIA_gf2n(static_gf2n res[NB_WORD_GFqn],
        cst_static_gf2n A[NB_WORD_GFqn]) {
    INIT_REGISTERS;
