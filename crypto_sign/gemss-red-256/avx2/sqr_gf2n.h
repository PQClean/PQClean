...
void PQCLEAN_GEMSSRED256_AVX2_sqr_no_simd_gf2x_ref2(static_gf2x C[NB_WORD_MUL],
...
void PQCLEAN_GEMSSRED256_AVX2_sqr_then_rem_gf2n(uint64_t res[NB_WORD_GFqn], const uint64_t A[NB_WORD_GFqn]);
void PQCLEAN_GEMSSRED256_AVX2_sqr_nocst_then_rem_gf2n(uint64_t res[NB_WORD_GFqn], const uint64_t A[NB_WORD_GFqn]);
...
/* Choice the best sqr */
#define sqr_nocst_gf2n PQCLEAN_GEMSSRED256_AVX2_sqr_nocst_then_rem_gf2n
#define sqr_gf2n PQCLEAN_GEMSSRED256_AVX2_sqr_then_rem_gf2n
