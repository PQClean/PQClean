 ...
 */
void PQCLEAN_GEMSSRED128_AVX2_convMQ_UL_gf2(uint8_t *pk2, const uint8_t *pk) {
 ...
 * @remark  Constant-time implementation.
 */
uint64_t PQCLEAN_GEMSSRED128_AVX2_convMQ_last_UL_gf2(uint8_t *pk2, const uint8_t *pk) {
    uint64_t val;
    unsigned int i, k, nb_bits;
    int j;
 ...
 * are missing (cf. the output of PQCLEAN_GEMSSRED128_AVX2_convMQ_last_UL_gf2). Moreover, the last byte
 ...
 * @remark  Constant-time implementation.
 */
UINT PQCLEAN_GEMSSRED128_AVX2_convMQ_last_uncompressL_gf2(uint64_t *pk2, const uint8_t *pk) {
    const uint64_t *pk64;
 ...
 * @remark  Constant-time implementation.
 */
UINT PQCLEAN_GEMSSRED128_AVX2_convMQ_uncompressL_gf2(uint64_t *pk2, const uint8_t *pk) {
    const uint64_t *pk64;
    unsigned int iq, ir, k, nb_bits;
