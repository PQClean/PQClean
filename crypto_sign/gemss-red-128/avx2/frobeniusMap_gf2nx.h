...
unsigned int PQCLEAN_GEMSSRED128_AVX2_frobeniusMap_multisqr_HFE_gf2nx(gf2nx Xqn,
        complete_sparse_monic_gf2nx F, cst_gf2n U);
...
#define best_frobeniusMap_HFE_gf2nx PQCLEAN_GEMSSRED128_AVX2_frobeniusMap_multisqr_HFE_gf2nx
