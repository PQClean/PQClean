...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_192fsimple_GenChain(uint8 *out, const uint8 *in, uint32 start, uint32 steps, 
                                                    const sphincs_shake_192f_ctx *ctx, uint32 addr[8]);
static void fsmsw_sphincsshake_192fsimple_BaseW(uint32 *output, const sint32 out_len, const uint8 *input);
static void fsmsw_sphincsshake_192fsimple_WotsChecksum(uint32 *csum_base_w, const uint32 *msg_base_w);

/**********************************************************************************************************************/
/* PRIVATE FUNCTIONS DEFINITIONS                                                                                      */
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192fsimple_GenChain
*
                                                    ...
                                                    const sphincs_shake_192f_ctx *ctx, uint32 addr[8])
{
    ...
    {
        FsmSw_SphincsShake_set_hash_addr(addr, i);
        FsmSw_SphincsShake_192fSimple_thash(out, out, 1, ctx, addr);
    }
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192fsimple_BaseW
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192fsimple_WotsChecksum
*
...
static void fsmsw_sphincsshake_192fsimple_WotsChecksum(uint32 *csum_base_w, const uint32 *msg_base_w)
{
    ...
    csum = csum << ((8u - ((FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN2 * FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LOGW) % 8u))
                     % 8u);
    FsmSw_Sphincs_ull_to_bytes(csum_bytes, sizeof(csum_bytes), csum);
    fsmsw_sphincsshake_192fsimple_BaseW(csum_base_w, (sint32)FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN2, csum_bytes);
}
...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_192fSimple_chain_lengths
*
...
{
    fsmsw_sphincsshake_192fsimple_BaseW(lengths, (sint32)FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN1, msg);
    fsmsw_sphincsshake_192fsimple_WotsChecksum(&lengths[FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN1], lengths);
}

/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_192fSimple_wots_pk_from_sig
*
...
void FsmSw_SphincsShake_192fSimple_wots_pk_from_sig(uint8 *pk, const uint8 *sig, const uint8 *msg,
                                                    const sphincs_shake_192f_ctx *ctx, uint32 addr[8])
{
    uint32 lengths[FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN];
    uint32 i;

    FsmSw_SphincsShake_192fSimple_chain_lengths(lengths, msg);

    for (i = 0; i < FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_LEN; i++)
    {
        FsmSw_SphincsShake_set_chain_addr(addr, i);
        fsmsw_sphincsshake_192fsimple_GenChain(&pk[i * FSMSW_SPHINCSSHAKE_192FSIMPLE_N], 
                                                &sig[i * FSMSW_SPHINCSSHAKE_192FSIMPLE_N], 
                                                lengths[i], FSMSW_SPHINCSSHAKE_192FSIMPLE_WOTS_W - 1u - lengths[i], 
                                                ctx, addr);
    }
}
