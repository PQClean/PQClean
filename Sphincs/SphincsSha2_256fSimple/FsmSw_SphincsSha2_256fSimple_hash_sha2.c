                                               ...
                                               const sphincs_sha2_256f_ctx *ctx)
{
    ...
    {
        FsmSw_CommonLib_memcpy(&inbuf[FSMSW_SPHINCSSHA2_256FSIMPLE_N + FSMSW_SPHINCSSHA2_256FSIMPLE_PK_BYTES],
        m_temp, mlen_temp);
    ...
    else
    {
        ...
        /* polyspace +2 MISRA2012:2.2 [Justified:]"Calculation is important if defines should change '
        and therefore not dead code" */ 
        mlen_temp -= (SPX_INBLOCKS * SPX_SHAX_BLOCK_BYTES) - FSMSW_SPHINCSSHA2_256FSIMPLE_N -
                FSMSW_SPHINCSSHA2_256FSIMPLE_PK_BYTES;
