...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_256fSimple_chain_lengths
*
...
void FsmSw_SphincsSha2_256fSimple_wots_pk_from_sig(uint8 *pk, const uint8 *sig, const uint8 *msg,
                                                   const sphincs_sha2_256f_ctx *ctx, uint32 addr[8])
{
    uint32 lengths[FSMSW_SPHINCSSHA2_256FSIMPLE_WOTS_LEN];
    uint32 i;

    FsmSw_SphincsSha2_256fSimple_chain_lengths(lengths, msg);
