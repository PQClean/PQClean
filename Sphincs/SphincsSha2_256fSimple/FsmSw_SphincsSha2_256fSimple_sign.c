...
/**********************************************************************************************************************/
static sint8 FsmSw_SphincsSha2_256fSimple_crypto_sign_seed_keypair(uint8 *pk, uint8 *sk, const uint8 *seed);
/**********************************************************************************************************************/
                                                       ...
                                                       const uint8 *sk)
{
    ...
    FsmSw_SphincsSha2_256fSimple_gen_message_random(sig_temp, sk_prf, optrand, m, mlen, &ctx);

    /* Derive the message digest and leaf index from R, PK and M. */
    FsmSw_SphincsSha2_256fSimple_hash_message(mhash, &tree, &idx_leaf, sig_temp, pk, m, mlen, &ctx);
    ...
    for (i = 0; i < FSMSW_SPHINCSSHA2_256FSIMPLE_D; i++)
    {
        ...
        sig_temp = &sig_temp[FSMSW_SPHINCSSHA2_256FSIMPLE_WOTS_BYTES + (FSMSW_SPHINCSSHA2_256FSIMPLE_TREE_HEIGHT *
                                                    ...
                                                    const uint8 *pk)
{
    ...
    FsmSw_SphincsSha2_256fSimple_fors_pk_from_sig(root, sig_temp, mhash, &ctx, wots_addr);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHA2_256FSIMPLE_FORS_BYTES];
    ...
    for (i = 0; i < FSMSW_SPHINCSSHA2_256FSIMPLE_D; i++)
    {
        ...
        FsmSw_SphincsSha2_256fSimple_wots_pk_from_sig(wots_pk, sig_temp, root, &ctx, wots_addr);
        ...
        FsmSw_SphincsSha2_256fSimple_compute_root(root, leaf, idx_leaf, 0, sig_temp,
