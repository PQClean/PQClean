...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_192sSimple_thash
*
* Description: Takes an array of inblocks concatenated arrays of FSMSW_SPHINCSSHA2_192SSIMPLE_N bytes.
*
                                        ...
                                        const uint32 addr[8])
{
    ...
    FsmSw_sha256_inc_finalize(outbuf, &sha2_state, buf, SPX_SHA256_ADDR_BYTES +
                              (inblocks * FSMSW_SPHINCSSHA2_192SSIMPLE_N));
