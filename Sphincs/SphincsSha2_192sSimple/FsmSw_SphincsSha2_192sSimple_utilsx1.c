...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_192sSimple_treehashx1
*
                                             ...
                                             uint32 tree_addr[8], void *info)
{
    ...
    uint8 stack[FSMSW_SPHINCSSHA2_192SSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHA2_192SSIMPLE_N];
    ...
    for (idx = 0; idx < 0xFFFFFFFFu; idx++)
    {
        ...
        for (h = 0; h < 0xFFFFFFFFu; h++)
        {
            ...
            {
                FsmSw_CommonLib_memcpy(&auth_path[h * FSMSW_SPHINCSSHA2_192SSIMPLE_N],
                                       &current[FSMSW_SPHINCSSHA2_192SSIMPLE_N],
            ...
            FsmSw_SphincsSha2_192sSimple_thash(&current[1u * FSMSW_SPHINCSSHA2_192SSIMPLE_N],
