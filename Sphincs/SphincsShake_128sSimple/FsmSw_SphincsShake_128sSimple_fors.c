...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_128ssimple_ForsGenSk(uint8 *sk, const sphincs_shake_128s_ctx *ctx, 
                                                      const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128ssimple_ForsSkToLeaf(uint8 *leaf, const uint8 *sk, 
                                                          const sphincs_shake_128s_ctx *ctx, 
                                                          const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128ssimple_ForsGenLeafx1(uint8 *leaf, const sphincs_shake_128s_ctx *ctx, 
                                                          uint32 addr_idx, void *info);
static void fsmsw_sphincsshake_128ssimple_MessageToIndices(uint32 *indices, const uint8 *m);

/**********************************************************************************************************************/
/* PRIVATE FUNCTIONS DEFINITIONS                                                                                      */
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128ssimple_ForsGenSk
*
* Description: t.b.d.
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128ssimple_ForsSkToLeaf
*
* Description: t.b.d.
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128ssimple_ForsGenLeafx1
*
* Description: t.b.d.
*
* Arguments:   -       uint8                  *leaf:     t.b.d.
                                                          ...
                                                          uint32 addr_idx, void *info)
{
    ...
    fsmsw_sphincsshake_128ssimple_ForsGenSk(leaf, ctx, fors_leaf_addr);

    FsmSw_SphincsShake_set_type(fors_leaf_addr, FSMSW_SPHINCS_ADDR_TYPE_FORSTREE);
    fsmsw_sphincsshake_128ssimple_ForsSkToLeaf(leaf, leaf, ctx, fors_leaf_addr);
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128ssimple_MessageToIndices
*
                                            ...
                                            const uint32 fors_addr[8])
{
    ...
    fsmsw_sphincsshake_128ssimple_MessageToIndices(indices, m);
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES; i++)
    {
        ...
        fsmsw_sphincsshake_128ssimple_ForsGenSk(sig_temp, ctx, fors_tree_addr);
        ...
        FsmSw_SphincsShake_128sSimple_treehashx1(&roots[i * FSMSW_SPHINCSSHAKE_128SSIMPLE_N], sig_temp, ctx,
                                                 ...
                                                 fsmsw_sphincsshake_128ssimple_ForsGenLeafx1, 
                                                    ...
                                                    const sphincs_shake_128s_ctx *ctx, const uint32 fors_addr[8])
{
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_128SSIMPLE_FORS_TREES; i++)
    {
        ...
        fsmsw_sphincsshake_128ssimple_ForsSkToLeaf(leaf, sig_temp, ctx, fors_tree_addr);
        sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_128SSIMPLE_N];
