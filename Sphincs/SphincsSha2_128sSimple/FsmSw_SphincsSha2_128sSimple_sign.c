...
int FsmSw_SphincsSha2_128sSimple_crypto_sign_seed_keypair(uint8 *pk, uint8 *sk, const uint8 *seed)
{
    ...
    FsmSw_SphincsSha2_128sSimple_initialize_hash_function(&ctx);

    /* Compute root node of the top-most subtree. */
    FsmSw_SphincsSha2_128sSimple_merkle_gen_root(&sk[3u * FSMSW_SPHINCSSHA2_128SSIMPLE_N], &ctx);

    FsmSw_CommonLib_memcpy(&pk[FSMSW_SPHINCSSHA2_128SSIMPLE_N],
                           &sk[3u * FSMSW_SPHINCSSHA2_128SSIMPLE_N], FSMSW_SPHINCSSHA2_128SSIMPLE_N);
...
int FsmSw_SphincsSha2_128sSimple_crypto_sign_keypair(uint8 *pk, uint8 *sk)
{
    ...
    (void)FsmSw_SphincsSha2_128sSimple_crypto_sign_seed_keypair(pk, sk, seed);
                                                       ...
                                                       const uint8 *sk)
{
    ...
    uint8 optrand[FSMSW_SPHINCSSHA2_128SSIMPLE_N];
    uint8 mhash[FSMSW_SPHINCSSHA2_128SSIMPLE_FORS_MSG_BYTES];
    uint8 root[FSMSW_SPHINCSSHA2_128SSIMPLE_N];
    uint32 i;
    uint64 tree;
    uint32 idx_leaf;
...
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_128sSimple_crypto_sign_verify
*
                                                    ...
                                                    const uint8 *pk)
{
    ...
    uint8 mhash[FSMSW_SPHINCSSHA2_128SSIMPLE_FORS_MSG_BYTES];
    uint8 wots_pk[FSMSW_SPHINCSSHA2_128SSIMPLE_WOTS_BYTES];
    uint8 root[FSMSW_SPHINCSSHA2_128SSIMPLE_N];
...
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_128sSimple_crypto_sign_open
*
