...
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_128fSimple_treehashx1
*
...
{
    uint8 stack[FSMSW_SPHINCSSHA2_128FSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHA2_128FSIMPLE_N];
    ...
    for(idx = 0; idx < 0xFFFFFFFFu ; idx++)
    {
        ...
        for(h = 0; h < 0xFFFFFFFFu ; h++)
        {
            ...
            {
                FsmSw_CommonLib_memcpy(&auth_path[h * FSMSW_SPHINCSSHA2_128FSIMPLE_N],
                                       &current[FSMSW_SPHINCSSHA2_128FSIMPLE_N],
            ...
            FsmSw_SphincsSha2_128fSimple_thash( &current[1u * FSMSW_SPHINCSSHA2_128FSIMPLE_N],
                                                &current[0u * FSMSW_SPHINCSSHA2_128FSIMPLE_N],
                                                2u, ctx, tree_addr);
            internal_idx >>= 1;
            internal_leaf >>= 1;
        }
