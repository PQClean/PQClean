...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_256sSimple_wots_gen_leafx1
*
...
*
***********************************************************************************************************************/
void FsmSw_SphincsSha2_256sSimple_wots_gen_leafx1(uint8 *dest, const sphincs_sha2_256s_ctx *ctx, uint32 leaf_idx,
                                                  void *v_info)
{
    ...
    uint32 i, k;
    uint8 pk_buffer[FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_BYTES];
    uint8 *buffer;
    uint32 wots_k_mask;
    ...
    for (i = 0; i < FSMSW_SPHINCSSHA2_256SSIMPLE_WOTS_LEN; i++)
    {
        ...
        FsmSw_SphincsSha2_256sSimple_prf_addr(buffer, ctx, leaf_addr);
