...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_192fsimple_GenChain(uint8 *out, const uint8 *in, uint32 start, uint32 steps, 
                                                   const sphincs_sha2_192f_ctx *ctx, uint32 addr[8]);
static void fsmsw_sphincssha2_192fsimple_BaseW(uint32 *output, sint32 out_len, const uint8 *input);
static void fsmsw_sphincssha2_192fsimple_WotsChecksum(uint32 *csum_base_w, const uint32 *msg_base_w);
/**********************************************************************************************************************/
/* PRIVATE FUNCTIONS DEFINITIONS                                                                                      */
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        fsmsw_sphincssha2_192fsimple_GenChain
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincssha2_192fsimple_BaseW
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincssha2_192fsimple_WotsChecksum
*
...
static void fsmsw_sphincssha2_192fsimple_WotsChecksum(uint32 *csum_base_w, const uint32 *msg_base_w)
{
    ...
    fsmsw_sphincssha2_192fsimple_BaseW(csum_base_w, (sint32)FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_LEN2, csum_bytes);
}
/**********************************************************************************************************************/
...
{
    fsmsw_sphincssha2_192fsimple_BaseW(lengths, (sint32)FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_LEN1, msg);
    fsmsw_sphincssha2_192fsimple_WotsChecksum(&lengths[FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_LEN1], lengths);
}
                                                   ...
                                                   const sphincs_sha2_192f_ctx *ctx, uint32 addr[8])
{
    ...
    for (i = 0; i < FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_LEN; i++)
    {
        ...
        fsmsw_sphincssha2_192fsimple_GenChain(&pk[i * FSMSW_SPHINCSSHA2_192FSIMPLE_N], 
                                               &sig[i * FSMSW_SPHINCSSHA2_192FSIMPLE_N],
                                               lengths[i], FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_W - 1u - lengths[i], 
                                               ctx, addr);
    }
}
