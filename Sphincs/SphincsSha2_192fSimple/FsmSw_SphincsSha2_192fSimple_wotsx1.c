...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_192fSimple_wots_gen_leafx1
*
                                                  ...
                                                  void *v_info)
{
    ...
    uint32 i, k;
    uint8 pk_buffer[FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_BYTES];
    uint8 *buffer;
    uint32 wots_k_mask;
    ...
    for (i = 0; i < FSMSW_SPHINCSSHA2_192FSIMPLE_WOTS_LEN; i++)
    {
        ...
        FsmSw_SphincsSha2_192fSimple_prf_addr(buffer, ctx, leaf_addr);
