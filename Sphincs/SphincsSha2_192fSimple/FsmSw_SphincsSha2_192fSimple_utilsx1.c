...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsSha2_192fSimple_treehashx1
*
...
void FsmSw_SphincsSha2_192fSimple_treehashx1(uint8 *root, uint8 *auth_path, const sphincs_sha2_192f_ctx *ctx,
                                             ...
                                             void (*gen_leaf)
                                             (
                                               uint8 *leaf /* Where to write the leaves */,
                                               const sphincs_sha2_192f_ctx *ctx,
                                               uint32 idx, void *info
                                             ),
                                             uint32 tree_addr[8], void *info)
{
    uint8 stack[FSMSW_SPHINCSSHA2_192FSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHA2_192FSIMPLE_N];
    ...
    for (idx = 0; idx < 0xFFFFFFFFu; idx++)
    {
        ...
        for (h = 0; h < 0xFFFFFFFFu; h++)
        {
            ...
            {
                FsmSw_CommonLib_memcpy(&auth_path[h * FSMSW_SPHINCSSHA2_192FSIMPLE_N],
                                       &current[FSMSW_SPHINCSSHA2_192FSIMPLE_N],
            ...
            FsmSw_SphincsSha2_192fSimple_thash(&current[1u * FSMSW_SPHINCSSHA2_192FSIMPLE_N],
                                               &current[0u * FSMSW_SPHINCSSHA2_192FSIMPLE_N],
                                               2u, ctx, tree_addr);
