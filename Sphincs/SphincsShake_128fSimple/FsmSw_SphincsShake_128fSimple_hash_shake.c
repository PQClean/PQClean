...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_128fSimple_prf_addr
*
...
*
***********************************************************************************************************************/
void FsmSw_SphincsShake_128fSimple_prf_addr(uint8 *out, const sphincs_shake_128f_ctx *ctx, const uint32 addr[8])
{
    uint8 buf[2u * FSMSW_SPHINCSSHAKE_128FSIMPLE_N + FSMSW_SPHINCSSHAKE_128FSIMPLE_ADDR_BYTES];
    ...
    FsmSw_CommonLib_memcpy(&buf[FSMSW_SPHINCSSHAKE_128FSIMPLE_N + FSMSW_SPHINCSSHAKE_128FSIMPLE_ADDR_BYTES],
                           ctx->sk_seed, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);

    FsmSw_Fips202_shake256(out, FSMSW_SPHINCSSHAKE_128FSIMPLE_N, buf, 2u * FSMSW_SPHINCSSHAKE_128FSIMPLE_N +
                           FSMSW_SPHINCSSHAKE_128FSIMPLE_ADDR_BYTES);
}

/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_128fSimple_gen_message_random
*
...
***********************************************************************************************************************/
void FsmSw_SphincsShake_128fSimple_gen_message_random(uint8 *R, const uint8 *sk_prf, const uint8 *optrand,
                                                      const uint8 *m, uint32 mlen, const sphincs_shake_128f_ctx *ctx)
{
    ...
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, sk_prf, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, optrand, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, m, mlen);
    FsmSw_Fips202_shake256_inc_finalize(&s_inc);
    FsmSw_Fips202_shake256_inc_squeeze(R, FSMSW_SPHINCSSHAKE_128FSIMPLE_N, &s_inc);
}
...
*
***********************************************************************************************************************/
void FsmSw_SphincsShake_128fSimple_hash_message(uint8 *digest, uint64 *tree, uint32 *leaf_idx, const uint8 *R,
                                                ...
                                                const sphincs_shake_128f_ctx *ctx)
{
    ...
    FsmSw_Fips202_shake256_inc_init(&s_inc);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, R, FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, pk, FSMSW_SPHINCSSHAKE_128FSIMPLE_PK_BYTES);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, m, mlen);
    FsmSw_Fips202_shake256_inc_finalize(&s_inc);
