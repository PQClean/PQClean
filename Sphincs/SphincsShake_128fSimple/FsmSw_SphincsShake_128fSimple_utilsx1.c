...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_128fSimple_treehashx1
*
                                              ...
                                              )
{
    ...
    uint8 stack[FSMSW_SPHINCSSHAKE_128FSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHAKE_128FSIMPLE_N];
    ...
    for (idx = 0; idx < 0xFFFFFFFFu; idx++)
    {
        ...
        for (h = 0; h < 0xFFFFFFFFu; h++)
        {
            ...
            if (h == tree_height)
            {
                ...
                FsmSw_CommonLib_memcpy(root, &current[FSMSW_SPHINCSSHAKE_128FSIMPLE_N],
            ...
            if ((internal_idx ^ internal_leaf) == 0x01u)
            {
                FsmSw_CommonLib_memcpy(&auth_path[ h * FSMSW_SPHINCSSHAKE_128FSIMPLE_N ],
                                       &current[FSMSW_SPHINCSSHAKE_128FSIMPLE_N],
                                       FSMSW_SPHINCSSHAKE_128FSIMPLE_N);
            }
            ...
            FsmSw_SphincsShake_128fSimple_thash(&current[1u * FSMSW_SPHINCSSHAKE_128FSIMPLE_N],
