...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_128fSimple_chain_lengths
*
...
void FsmSw_SphincsShake_128fSimple_wots_pk_from_sig(uint8 *pk, const uint8 *sig, const uint8 *msg,
    ...
    uint32 lengths[FSMSW_SPHINCSSHAKE_128FSIMPLE_WOTS_LEN];
    uint32 i;

    FsmSw_SphincsShake_128fSimple_chain_lengths(lengths, msg);
