...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_128fsimple_ForsGenSk(uint8 *sk, const sphincs_shake_128f_ctx *ctx, 
                                                      const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128fsimple_ForsSkToLeaf(uint8 *leaf, const uint8 *sk, 
                                                          const sphincs_shake_128f_ctx *ctx, 
                                                          const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128fsimple_ForsGenLeafx1(uint8 *leaf, const sphincs_shake_128f_ctx *ctx, 
                                                          uint32 addr_idx, void *info);
static void fsmsw_sphincsshake_128fsimple_MessageToIndices(uint32 *indices, const uint8 *m);

/**********************************************************************************************************************/
/* PRIVATE FUNCTIONS DEFINITIONS                                                                                      */
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128fsimple_ForsGenSk
*
* Description: t.b.d
*
...
static void fsmsw_sphincsshake_128fsimple_ForsGenSk(uint8 *sk, const sphincs_shake_128f_ctx *ctx, 
                                                      const uint32 fors_leaf_addr[8])
{
    FsmSw_SphincsShake_128fSimple_prf_addr(sk, ctx, fors_leaf_addr);
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128fsimple_ForsSkToLeaf
*
* Description: t.b.d
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128fsimple_ForsGenLeafx1
*
* Description: t.b.d
*
* Arguments:   -       uint8                  *leaf:     t.b.d
                                                          ...
                                                          uint32 addr_idx, void *info)
{
    ...
    fsmsw_sphincsshake_128fsimple_ForsGenSk(leaf, ctx, fors_leaf_addr);

    FsmSw_SphincsShake_set_type(fors_leaf_addr, FSMSW_SPHINCS_ADDR_TYPE_FORSTREE);
    fsmsw_sphincsshake_128fsimple_ForsSkToLeaf(leaf, leaf, ctx, fors_leaf_addr);
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_128fsimple_MessageToIndices
*
* Description: Interprets m as FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_HEIGHT-bit uint32. Assumes m contains at least
...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_128fSimple_fors_sign
*
...
{
    uint32 indices[FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_TREES];
    uint8 roots[FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_TREES * FSMSW_SPHINCSSHAKE_128FSIMPLE_N];
    ...
    fsmsw_sphincsshake_128fsimple_MessageToIndices(indices, m);
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_TREES; i++)
    {
        ...
        fsmsw_sphincsshake_128fsimple_ForsGenSk(sig_temp, ctx, fors_tree_addr);
        ...
        FsmSw_SphincsShake_128fSimple_treehashx1(&roots[i * FSMSW_SPHINCSSHAKE_128FSIMPLE_N], sig_temp, ctx, indices[i],
                                                 ...
                                                 fsmsw_sphincsshake_128fsimple_ForsGenLeafx1,
...
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_128fSimple_fors_pk_from_sig
*
                                                    ...
                                                    const sphincs_shake_128f_ctx *ctx, const uint32 fors_addr[8])
{
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_TREES; i++)
    {
        ...
        fsmsw_sphincsshake_128fsimple_ForsSkToLeaf(leaf, sig_temp, ctx, fors_tree_addr);
        sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_128FSIMPLE_N];

        /* Derive the corresponding root node of this tree. */
        FsmSw_SphincsShake_128fSimple_compute_root(&roots[i * FSMSW_SPHINCSSHAKE_128FSIMPLE_N], leaf, indices[i],
                                                   idx_offset, sig_temp, FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_HEIGHT, ctx,
                                                   fors_tree_addr);
        sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_128FSIMPLE_N * FSMSW_SPHINCSSHAKE_128FSIMPLE_FORS_HEIGHT];
    }
