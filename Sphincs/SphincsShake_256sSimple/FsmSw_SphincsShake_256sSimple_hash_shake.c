...
{
    uint8 buf[(2u * FSMSW_SPHINCSSHAKE_256SSIMPLE_N) + FSMSW_SPHINCSSHAKE_256SSIMPLE_ADDR_BYTES];
    ...
    FsmSw_CommonLib_memcpy(&buf[FSMSW_SPHINCSSHAKE_256SSIMPLE_N + FSMSW_SPHINCSSHAKE_256SSIMPLE_ADDR_BYTES],
                           ctx->sk_seed, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
                                                      ...
                                                      const uint8 *m, uint32 mlen, const sphincs_shake_256s_ctx *ctx)
{
    ...
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, sk_prf, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, optrand, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, m, mlen);
    FsmSw_Fips202_shake256_inc_finalize(&s_inc);
    FsmSw_Fips202_shake256_inc_squeeze(R, FSMSW_SPHINCSSHAKE_256SSIMPLE_N, &s_inc);
}
                                                ...
                                                const sphincs_shake_256s_ctx *ctx)
{
    ...
    FsmSw_Fips202_shake256_inc_init(&s_inc);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, R, FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, pk, FSMSW_SPHINCSSHAKE_256SSIMPLE_PK_BYTES);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, m, mlen);
    FsmSw_Fips202_shake256_inc_finalize(&s_inc);
