...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_256ssimple_GenChain
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_256ssimple_BaseW
*
...
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_256ssimple_WotsChecksum
*
                                                    ...
                                                    const sphincs_shake_256s_ctx *ctx, uint32 addr[8])
{
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_LEN; i++)
    {
        ...
        fsmsw_sphincsshake_256ssimple_GenChain(&pk[i * FSMSW_SPHINCSSHAKE_256SSIMPLE_N], 
                                                &sig[i * FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
                                                lengths[i], FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_W - 1u - lengths[i], 
                                                ctx, addr);
    }
}
