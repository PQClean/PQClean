...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256sSimple_treehashx1
*
                                              ...
                                              )
{
    ...
    uint8 stack[FSMSW_SPHINCSSHAKE_256SSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHAKE_256SSIMPLE_N];
    ...
    for (idx = 0; idx < 0xFFFFFFFFu; idx++)
    {
        ...
        for (h = 0; h < 0xFFFFFFFFu; h++)
        {
            ...
            if (h == tree_height)
            {
                ...
                FsmSw_CommonLib_memcpy(root, &current[FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
            ...
            if ((internal_idx ^ internal_leaf) == 0x01u)
            {
                FsmSw_CommonLib_memcpy(&auth_path[h * FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
                                       &current[FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
                                       FSMSW_SPHINCSSHAKE_256SSIMPLE_N);
            }
            ...
            FsmSw_SphincsShake_256sSimple_thash(&current[1u * FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
                                                &current[0u * FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
                                                2u, ctx, tree_addr);
