...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256sSimple_wots_gen_leafx1
*
...
*
***********************************************************************************************************************/
void FsmSw_SphincsShake_256sSimple_wots_gen_leafx1(uint8 *dest, const sphincs_shake_256s_ctx *ctx, uint32 leaf_idx,
                                                   void *v_info)
{
    ...
    uint32 i, k;
    uint8 pk_buffer[ FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_BYTES ];
    uint8 *buffer;
    uint32 wots_k_mask;
