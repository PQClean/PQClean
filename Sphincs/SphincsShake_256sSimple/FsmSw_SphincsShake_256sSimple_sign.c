...
/**********************************************************************************************************************/
static sint8 FsmSw_SphincsShake_256sSimple_crypto_sign_seed_keypair(uint8 *pk, uint8 *sk, const uint8 *seed);
/**********************************************************************************************************************/
...
static sint8 FsmSw_SphincsShake_256sSimple_crypto_sign_seed_keypair(uint8 *pk, uint8 *sk, const uint8 *seed)
{
    ...
    /* cleanup */
    FsmSw_SphincsShake_256sSimple_1_free_hash_function(&ctx);
                                                        ...
                                                        const uint8 *sk)
{
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_256SSIMPLE_D; i++)
    {
        ...
        sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_BYTES + (FSMSW_SPHINCSSHAKE_256SSIMPLE_TREE_HEIGHT *
                                                     ...
                                                     const uint8 *pk)
{
    ...
    * The additional FSMSW_SPHINCSSHAKE_256SSIMPLE_N is a result of the hash domain separator. */
    ...
    FsmSw_SphincsShake_256sSimple_fors_pk_from_sig(root, sig_temp, mhash, &ctx, wots_addr);
    sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_256SSIMPLE_FORS_BYTES];
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_256SSIMPLE_D; i++)
    {
        ...
        FsmSw_SphincsShake_256sSimple_wots_pk_from_sig(wots_pk, sig_temp, root, &ctx, wots_addr);
        ...
        FsmSw_SphincsShake_256sSimple_compute_root(root, leaf, idx_leaf, 0, sig_temp,
