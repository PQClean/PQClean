...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_192sSimple_wots_gen_leafx1
*
                                                   ...
                                                   void *v_info)
{
    ...
    uint32 i, k;
    uint8 pk_buffer[ FSMSW_SPHINCSSHAKE_192SSIMPLE_WOTS_BYTES ];
    uint8 *buffer;
    uint32 wots_k_mask;
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_192SSIMPLE_WOTS_LEN; i++)
    {
        ...
        FsmSw_SphincsShake_192sSimple_prf_addr(buffer, ctx, leaf_addr);
