...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_192ssimple_ForsGenSk(uint8 *sk, const sphincs_shake_192s_ctx *ctx, 
                                                      const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_192ssimple_ForsSkToLeaf(uint8 *leaf, const uint8 *sk, 
                                                          const sphincs_shake_192s_ctx *ctx, 
                                                          const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_192ssimple_ForsGenLeafx1(uint8 *leaf, const sphincs_shake_192s_ctx *ctx, 
                                                        uint32 addr_idx, void *info);
static void fsmsw_sphincsshake_192ssimple_MessageToIndices(uint32 *indices, const uint8 *m);

/**********************************************************************************************************************/
/* PRIVATE FUNCTIONS DEFINITIONS                                                                                      */
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192ssimple_ForsGenSk
*
* Description: t.b.d
*
...
static void fsmsw_sphincsshake_192ssimple_ForsGenSk(uint8 *sk, const sphincs_shake_192s_ctx *ctx, 
                                                      const uint32 fors_leaf_addr[8])
{
    FsmSw_SphincsShake_192sSimple_prf_addr(sk, ctx, fors_leaf_addr);
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192ssimple_ForsSkToLeaf
*
* Description: t.b.d
*
...
static void fsmsw_sphincsshake_192ssimple_ForsSkToLeaf(uint8 *leaf, const uint8 *sk, 
                                                          ...
                                                          const uint32 fors_leaf_addr[8])
{
    FsmSw_SphincsShake_192sSimple_1_thash(leaf, sk, 1, ctx, fors_leaf_addr);
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192ssimple_ForsGenLeafx1
*
* Description: t.b.d
*
* Arguments:   -       uint8                  *leaf:     t.b.d.
                                                        ...
                                                        uint32 addr_idx, void *info)
{
    ...
    fsmsw_sphincsshake_192ssimple_ForsGenSk(leaf, ctx, fors_leaf_addr);

    FsmSw_SphincsShake_set_type(fors_leaf_addr, FSMSW_SPHINCS_ADDR_TYPE_FORSTREE);
    fsmsw_sphincsshake_192ssimple_ForsSkToLeaf(leaf, leaf, ctx, fors_leaf_addr);
}

/***********************************************************************************************************************
* Name:        fsmsw_sphincsshake_192ssimple_MessageToIndices
*
...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_192sSimple_5_fors_sign
*
...
*
***********************************************************************************************************************/
void FsmSw_SphincsShake_192sSimple_5_fors_sign(uint8 *sig, uint8 *pk, const uint8 *m, const sphincs_shake_192s_ctx *ctx,
                                            const uint32 fors_addr[8])
{
    uint32 indices[FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_TREES];
    uint8 roots[FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_TREES * FSMSW_SPHINCSSHAKE_192SSIMPLE_N];
    ...
    fsmsw_sphincsshake_192ssimple_MessageToIndices(indices, m);
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_TREES; i++)
    {
        ...
        fsmsw_sphincsshake_192ssimple_ForsGenSk(sig_temp, ctx, fors_tree_addr);
        ...
        FsmSw_SphincsShake_192sSimple_3_treehashx1(&roots[i * FSMSW_SPHINCSSHAKE_192SSIMPLE_N], sig_temp, ctx,
                                                 indices[i], idx_offset, FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_HEIGHT,
                                                 fsmsw_sphincsshake_192ssimple_ForsGenLeafx1, 
    ...
    FsmSw_SphincsShake_192sSimple_1_thash(pk, roots, FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_TREES, ctx, fors_pk_addr);
}

/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_192sSimple_fors_pk_from_sig
*
...
*
***********************************************************************************************************************/
void FsmSw_SphincsShake_192sSimple_fors_pk_from_sig(uint8 *pk, const uint8 *sig, const uint8 *m,
                                                    const sphincs_shake_192s_ctx *ctx, const uint32 fors_addr[8])
{
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_TREES; i++)
    {
        ...
        fsmsw_sphincsshake_192ssimple_ForsSkToLeaf(leaf, sig_temp, ctx, fors_tree_addr);
        sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_192SSIMPLE_N];

        /* Derive the corresponding root node of this tree. */
        FsmSw_SphincsShake_192sSimple_compute_root(&roots[i * FSMSW_SPHINCSSHAKE_192SSIMPLE_N], leaf, indices[i],
		                                               idx_offset, sig_temp, FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_HEIGHT, 
                                                       ctx, fors_tree_addr);
        sig_temp = &sig_temp[FSMSW_SPHINCSSHAKE_192SSIMPLE_N * FSMSW_SPHINCSSHAKE_192SSIMPLE_FORS_HEIGHT];
    }
