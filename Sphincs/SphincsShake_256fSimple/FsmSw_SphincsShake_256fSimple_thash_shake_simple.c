...
*
* Description: Takes an array of inblocks concatenated arrays of FSMSW_SPHINCSSHAKE_256FSIMPLE_N bytes.
*
                                         ...
                                         const sphincs_shake_256f_ctx *ctx, const uint32 addr[8])
{
    uint8 buf[FSMSW_SPHINCSSHAKE_256FSIMPLE_N + FSMSW_SPHINCSSHAKE_256FSIMPLE_ADDR_BYTES +
              (FSMSW_SPHINCSSHAKE_256FSIMPLE_THASH_BUF_LEN * FSMSW_SPHINCSSHAKE_256FSIMPLE_N)];
    ...
    FsmSw_Fips202_shake256(out, FSMSW_SPHINCSSHAKE_256FSIMPLE_N, buf, FSMSW_SPHINCSSHAKE_256FSIMPLE_N +
                           FSMSW_SPHINCSSHAKE_256FSIMPLE_ADDR_BYTES + (inblocks * FSMSW_SPHINCSSHAKE_256FSIMPLE_N));
}
