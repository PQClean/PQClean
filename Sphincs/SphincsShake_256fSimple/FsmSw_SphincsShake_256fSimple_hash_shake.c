...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256fSimple_prf_addr
*
...
{
    uint8 buf[2u * FSMSW_SPHINCSSHAKE_256FSIMPLE_N + FSMSW_SPHINCSSHAKE_256FSIMPLE_ADDR_BYTES];
    ...
    FsmSw_CommonLib_memcpy(&buf[FSMSW_SPHINCSSHAKE_256FSIMPLE_N + FSMSW_SPHINCSSHAKE_256FSIMPLE_ADDR_BYTES],
                           ctx->sk_seed, FSMSW_SPHINCSSHAKE_256FSIMPLE_N);
...
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256fSimple_gen_message_random
*
                                                      ...
                                                      const uint8 *m, uint32 mlen, const sphincs_shake_256f_ctx *ctx)
{
    ...
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, sk_prf, FSMSW_SPHINCSSHAKE_256FSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, optrand, FSMSW_SPHINCSSHAKE_256FSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, m, mlen);
    FsmSw_Fips202_shake256_inc_finalize(&s_inc);
    FsmSw_Fips202_shake256_inc_squeeze(R, FSMSW_SPHINCSSHAKE_256FSIMPLE_N, &s_inc);
}

/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256fSimple_hash_message
*
                                                ...
                                                const sphincs_shake_256f_ctx *ctx)
{
    ...
    FsmSw_Fips202_shake256_inc_init(&s_inc);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, R, FSMSW_SPHINCSSHAKE_256FSIMPLE_N);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, pk, FSMSW_SPHINCSSHAKE_256FSIMPLE_PK_BYTES);
    FsmSw_Fips202_shake256_inc_absorb(&s_inc, m, mlen);
    FsmSw_Fips202_shake256_inc_finalize(&s_inc);
