 ...
 */
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256fSimple_wots_gen_leafx1
*
                                                   ...
                                                   void *v_info)
{
    ...
    uint32 i, k;
    uint8  pk_buffer[FSMSW_SPHINCSSHAKE_256FSIMPLE_WOTS_BYTES];
    uint8 *buffer;
    uint32 wots_k_mask;
    ...
    for (i = 0; i < FSMSW_SPHINCSSHAKE_256FSIMPLE_WOTS_LEN; i++)
    {
        ...
        FsmSw_SphincsShake_256fSimple_prf_addr(buffer, ctx, leaf_addr);
