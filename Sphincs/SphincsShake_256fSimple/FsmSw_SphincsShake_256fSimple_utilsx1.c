...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_SphincsShake_256fSimple_treehashx1
*
...
void FsmSw_SphincsShake_256fSimple_treehashx1(uint8 *root, uint8 *auth_path, const sphincs_shake_256f_ctx *ctx,
                                              ...
                                              (
                                                ...
                                                const sphincs_shake_256f_ctx *ctx /* ctx */,
                                              ...
                                              )
{
    ...
    uint8 stack[FSMSW_SPHINCSSHAKE_256FSIMPLE_TREEHASHX1_BUF_LEN * FSMSW_SPHINCSSHAKE_256FSIMPLE_N];
    ...
    for (idx = 0; idx < 0xFFFFFFFFu; idx++)
    {
        ...
        for (h = 0; h < 0xFFFFFFFFu; h++)
        {
            ...
            if (h == tree_height)
            {
                ...
                FsmSw_CommonLib_memcpy(root, &current[FSMSW_SPHINCSSHAKE_256FSIMPLE_N],
            ...
            if ((internal_idx ^ internal_leaf) == 0x01u)
            {
                FsmSw_CommonLib_memcpy(&auth_path[ h * FSMSW_SPHINCSSHAKE_256FSIMPLE_N ],
                                       &current[FSMSW_SPHINCSSHAKE_256FSIMPLE_N],
                                       FSMSW_SPHINCSSHAKE_256FSIMPLE_N);
            }
            ...
            FsmSw_SphincsShake_256fSimple_thash(&current[1u * FSMSW_SPHINCSSHAKE_256FSIMPLE_N],
                                                &current[0u * FSMSW_SPHINCSSHAKE_256FSIMPLE_N],
                                                2u, ctx, tree_addr);
