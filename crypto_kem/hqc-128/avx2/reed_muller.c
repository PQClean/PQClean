 ...
 */
void PQCLEAN_HQC128_AVX2_reed_muller_encode(uint64_t *cdw, const uint64_t *msg) {
 ...
 */
void PQCLEAN_HQC128_AVX2_reed_muller_decode(uint64_t *msg, const uint64_t *cdw) {
    uint8_t *message_array = (uint8_t *) msg;
    codeword *codeArray = (codeword *) cdw;
