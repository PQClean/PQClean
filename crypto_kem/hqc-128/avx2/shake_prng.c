...
/**
 * @file shake_prng.c
 * @brief Implementation of SHAKE-256 based PRNG and PQCLEAN_HQC128_AVX2_seedexpander
 */
...
/**
 * @brief Initialiase a SHAKE-256 based PQCLEAN_HQC128_AVX2_seedexpander
 *
 * Derived from function SHAKE_256 in fips202.c
 *
...
/**
 * @brief A SHAKE-256 based PQCLEAN_HQC128_AVX2_seedexpander
 *
 * Derived from function SHAKE_256 in fips202.c
