...
void toom_3_mult(__m256i *Out, const __m256i *A256, const __m256i *B256) {
    ...
    for (int32_t i = T_TM3R_3W_256 - 1; i < T_TM3R_3W_256; i++) {
        ...
        U1[i] = (__m256i) {
            A[i4 + T_TM3R_3W_64 - 2], A[i41 + T_TM3R_3W_64 - 2], 0x0ul, 0x0ul
        };
        V1[i] = (__m256i) {
            B[i4 + T_TM3R_3W_64 - 2], B[i41 + T_TM3R_3W_64 - 2], 0x0ul, 0x0ul
        };
    ...
    W0[0] = (__m256i) {
        0ul, U1_64[0], U1_64[1] ^ U2_64[0], U1_64[2] ^ U2_64[1]
    };
    W4[0] = (__m256i) {
        0ul, V1_64[0], V1_64[1] ^ V2_64[0], V1_64[2] ^ V2_64[1]
    };
 ...
 */
void PQCLEAN_HQC128_AVX2_vect_mul(__m256i *o, const __m256i *a1, const __m256i *a2) {
