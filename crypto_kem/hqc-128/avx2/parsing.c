 ...
 */
void PQCLEAN_HQC128_AVX2_hqc_secret_key_to_string(uint8_t *sk, const uint8_t *sk_seed, const uint8_t *sigma, const uint8_t *pk) {
 ...
 */
void PQCLEAN_HQC128_AVX2_hqc_secret_key_from_string(__m256i *x256, __m256i *y256, uint8_t *sigma, uint8_t *pk, const uint8_t *sk) {
    ...
    PQCLEAN_HQC128_AVX2_vect_set_random_fixed_weight(&sk_seedexpander, x256, PARAM_OMEGA);
    PQCLEAN_HQC128_AVX2_vect_set_random_fixed_weight(&sk_seedexpander, y256, PARAM_OMEGA);
 ...
 */
void PQCLEAN_HQC128_AVX2_hqc_ciphertext_to_string(uint8_t *ct, const uint64_t *u, const uint64_t *v, const uint64_t *salt) {
 ...
 */
void PQCLEAN_HQC128_AVX2_hqc_ciphertext_from_string(uint64_t *u, uint64_t *v, uint64_t *salt, const uint8_t *ct) {
