...
.word 4095
.text
.hidden PQCLEAN_NTRUHPS4096821_AVX2_poly_Rq_mul
...
subq $11584, %rsp
mov $4, %ecx
karatsuba_loop_66998e472cfa6be763ad6301f68cb8eb:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_66998e472cfa6be763ad6301f68cb8eb:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_66998e472cfa6be763ad6301f68cb8eb
add $832, %r9
add $1664, %r10
jmp innerloop_66998e472cfa6be763ad6301f68cb8eb
done_66998e472cfa6be763ad6301f68cb8eb:
sub $832, %r9
sub $1664, %r10
vmovdqa 0(%r9), %ymm0
...
add $4096, %r12
dec %ecx
jnz karatsuba_loop_66998e472cfa6be763ad6301f68cb8eb
sub $16384, %r12
add $11584, %rsp
subq $1280, %rsp
