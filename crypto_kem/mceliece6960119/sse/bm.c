...
extern gf PQCLEAN_MCELIECE6960119_SSE_vec_reduce_asm(vec128 *);
extern void PQCLEAN_MCELIECE6960119_SSE_update_asm(vec128 *, gf);
...
void PQCLEAN_MCELIECE6960119_SSE_bm(vec128 *out, vec128 in[][ GFBITS ]) {
    int i;
    uint16_t N, L;
    uint16_t mask;
    uint64_t one = 1;
