...
/**
 * @file shake_prng.c
 * @brief Implementation of SHAKE-256 based PRNG and PQCLEAN_HQC256_AVX2_seedexpander
 */
 ...
 */
void PQCLEAN_HQC256_AVX2_shake_prng_init(uint8_t *entropy_input, uint8_t *personalization_string, uint32_t enlen, uint32_t perlen) {
 ...
 */
void PQCLEAN_HQC256_AVX2_shake_prng(uint8_t *output, uint32_t outlen) {
...
/**
 * @brief Initialiase a SHAKE-256 based PQCLEAN_HQC256_AVX2_seedexpander
 *
 * Derived from function SHAKE_256 in fips202.c
 *
 ...
 */
void PQCLEAN_HQC256_AVX2_seedexpander_init(seedexpander_state *state, const uint8_t *seed, uint32_t seedlen) {
...
/**
 * @brief A SHAKE-256 based PQCLEAN_HQC256_AVX2_seedexpander
 *
 * Derived from function SHAKE_256 in fips202.c
 ...
 */
void PQCLEAN_HQC256_AVX2_seedexpander(seedexpander_state *state, uint8_t *output, uint32_t outlen) {
