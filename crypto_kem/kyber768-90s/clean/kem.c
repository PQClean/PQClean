...
* Returns 0 (success)
**************************************************/
int PQCLEAN_KYBER76890S_CLEAN_crypto_kem_keypair(uint8_t *pk,
        uint8_t *sk) {
    size_t i;
...
* Returns 0 (success)
**************************************************/
int PQCLEAN_KYBER76890S_CLEAN_crypto_kem_enc(uint8_t *ct,
        uint8_t *ss,
        const uint8_t *pk) {
...
**************************************************/
int PQCLEAN_KYBER76890S_CLEAN_crypto_kem_dec(uint8_t *ss,
        const uint8_t *ct,
        const uint8_t *sk) {
    size_t i;
    int fail;
