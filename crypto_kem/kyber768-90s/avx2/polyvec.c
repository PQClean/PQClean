...
**************************************************/
void PQCLEAN_KYBER76890S_AVX2_polyvec_compress(uint8_t r[KYBER_POLYVECCOMPRESSEDBYTES + 2], const polyvec *a) {
    size_t i;
...
*              - polyvec *a: pointer to input vector of polynomials
**************************************************/
void PQCLEAN_KYBER76890S_AVX2_polyvec_tobytes(uint8_t r[KYBER_POLYVECBYTES], const polyvec *a) {
    size_t i;
    for (i = 0; i < KYBER_K; i++) {
