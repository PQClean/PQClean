#ifndef PQCLEAN_KYBER76890S_AVX2_SYMMETRIC_H
#define PQCLEAN_KYBER76890S_AVX2_SYMMETRIC_H
#include "aes256ctr.h"
#include "params.h"
#include "sha2.h"
#include <stddef.h>
...
#define xof_absorb(STATE, SEED, X, Y) PQCLEAN_KYBER76890S_AVX2_aes256ctr_init(STATE, SEED, (X) | ((uint16_t)(Y) << 8))
