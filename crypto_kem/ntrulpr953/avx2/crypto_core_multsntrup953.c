...
/*
  ...
  y_7681[1] = -3593;
  PQCLEAN_NTRULPR953_AVX2_ntt512_7681(y_7681,1);
  ...
  for (i = 0;i < 512;++i) y_10753[i] = 0;
  y_10753[1] = 1018;
  PQCLEAN_NTRULPR953_AVX2_ntt512_10753(y_10753,1);
*/
...
#define h_10753 (aligned_h_10753.v)
    ...
    PQCLEAN_NTRULPR953_AVX2_ntt512_7681(fgpad.v[0], 8);
    ...
    PQCLEAN_NTRULPR953_AVX2_invntt512_7681(hpad[0], 4);
    unstride(h_7681, (const int16(*)[512]) hpad);

    stride(fpad, f);
    stride(gpad, g);

    PQCLEAN_NTRULPR953_AVX2_ntt512_10753(fgpad.v[0], 8);
    ...
    PQCLEAN_NTRULPR953_AVX2_invntt512_10753(hpad[0], 4);
