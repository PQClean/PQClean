...
void PQCLEAN_LEDACRYPT23371_CLEAN_gf2x_transpose_in_place(DIGIT
...
#define GF2X_DIGIT_MOD_INVERSE PQCLEAN_LEDACRYPT23371_CLEAN_gf2x_mod_inverse
int PQCLEAN_LEDACRYPT23371_CLEAN_gf2x_mod_inverse(DIGIT *out, const DIGIT *in);
/*----------------------------------------------------------------------------*/
