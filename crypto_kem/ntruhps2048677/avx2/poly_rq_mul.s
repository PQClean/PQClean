...
.word 2047
.text
.hidden PQCLEAN_NTRUHPS2048677_AVX2_poly_Rq_mul
...
subq $9408, %rsp
mov $4, %ecx
karatsuba_loop_48e4d1651e2cee3c5a86a45d80f44517:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_48e4d1651e2cee3c5a86a45d80f44517:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_48e4d1651e2cee3c5a86a45d80f44517
add $704, %r9
add $1408, %r10
jmp innerloop_48e4d1651e2cee3c5a86a45d80f44517
done_48e4d1651e2cee3c5a86a45d80f44517:
sub $704, %r9
sub $1408, %r10
vmovdqa 0(%r9), %ymm0
...
add $3072, %r12
dec %ecx
jnz karatsuba_loop_48e4d1651e2cee3c5a86a45d80f44517
sub $12288, %r12
add $9408, %rsp
subq $1280, %rsp
