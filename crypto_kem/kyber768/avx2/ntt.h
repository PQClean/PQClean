...
void PQCLEAN_KYBER768_AVX2_nttpack_avx(int16_t *r, const qdata_t *PQCLEAN_KYBER768_AVX2_qdata);
void PQCLEAN_KYBER768_AVX2_nttunpack_avx(int16_t *r, const qdata_t *PQCLEAN_KYBER768_AVX2_qdata);

void PQCLEAN_KYBER768_AVX2_basemul_avx(int16_t *r,
                                       const int16_t *a,
                                       const int16_t *b,
                                       const qdata_t *PQCLEAN_KYBER768_AVX2_qdata);
void PQCLEAN_KYBER768_AVX2_basemul_acc_avx(int16_t *r,
        const int16_t *a,
        const int16_t *b,
        const qdata_t *PQCLEAN_KYBER768_AVX2_qdata);
