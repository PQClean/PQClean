...
#define PQCLEAN_MCELIECE348864F_SSE_vec128_extract(a, i) ((uint64_t) _mm_extract_epi64((vec128) (a), (i)))
...
extern void PQCLEAN_MCELIECE348864F_SSE_vec128_mul_asm(vec128 *, vec128 *, const vec128 *, int);
