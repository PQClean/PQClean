...
static inline void PQCLEAN_MCELIECE8192128_AVX_transpose_64x128_sp(vec128 *in) {
...
static inline void PQCLEAN_MCELIECE8192128_AVX_transpose_64x256_sp(vec256 *in) {
