...
subq $6656, %rsp
mov $4, %ecx
karatsuba_loop_7e89e78a3e2390a5ee3f495f4d0d4364:
mov %rsp, %r9
mov %rsp, %r10
subq $32, %rsp
vmovdqa 0(%rax), %ymm0
...
addq $32, %rsp
innerloop_7e89e78a3e2390a5ee3f495f4d0d4364:
vmovdqa 0(%r9), %ymm0
...
neg %ecx
jns done_7e89e78a3e2390a5ee3f495f4d0d4364
add $512, %r9
add $1024, %r10
jmp innerloop_7e89e78a3e2390a5ee3f495f4d0d4364
done_7e89e78a3e2390a5ee3f495f4d0d4364:
sub $512, %r9
sub $1024, %r10
vmovdqa 0(%r9), %ymm0
...
add $2048, %r12
dec %ecx
jnz karatsuba_loop_7e89e78a3e2390a5ee3f495f4d0d4364
sub $8192, %r12
add $6656, %rsp
subq $2400, %rsp
