...
int PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_enc(
    ...
    PQCLEAN_MCELIECE6960119F_CLEAN_encrypt(c, pk, e);
...
int PQCLEAN_MCELIECE6960119F_CLEAN_crypto_kem_dec(
    ...
    ret_decrypt = PQCLEAN_MCELIECE6960119F_CLEAN_decrypt(e, sk + SYS_N / 8, c);
...
(
    ...
    while (1) {
        ...
        if (PQCLEAN_MCELIECE6960119F_CLEAN_pk_gen(pk, sk + SYS_N / 8, perm)) {
            continue;
        }
