...
extern void PQCLEAN_MCELIECE460896F_SSE_vec128_mul_asm(vec128 *, vec128 *, const vec128 *);

/* bitsliced field multiplications */
static inline void vec128_mul(vec128 *h, vec128 *f, const vec128 *g) {
    PQCLEAN_MCELIECE460896F_SSE_vec128_mul_asm(h, f, g);
}

void PQCLEAN_MCELIECE460896F_SSE_vec128_sq(vec128 * /*out*/, vec128 * /*in*/);
void PQCLEAN_MCELIECE460896F_SSE_vec128_inv(vec128 * /*out*/, vec128 * /*in*/);
