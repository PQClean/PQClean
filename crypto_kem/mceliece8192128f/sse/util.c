...
vec128 PQCLEAN_MCELIECE8192128F_SSE_load16(const unsigned char *in) {
    return vec128_set2x( PQCLEAN_MCELIECE8192128F_SSE_load8(in), PQCLEAN_MCELIECE8192128F_SSE_load8(in + 8) );
}

void PQCLEAN_MCELIECE8192128F_SSE_store16(unsigned char *out, vec128 in) {
    PQCLEAN_MCELIECE8192128F_SSE_store8(out + 0, vec128_extract(in, 0));
    PQCLEAN_MCELIECE8192128F_SSE_store8(out + 8, vec128_extract(in, 1));
}
