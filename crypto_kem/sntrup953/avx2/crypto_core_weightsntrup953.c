...
int PQCLEAN_SNTRUP953_AVX2_crypto_core_weightsntrup953(unsigned char *outbytes, const unsigned char *inbytes) {
    ...
    PQCLEAN_SNTRUP953_AVX2_crypto_encode_int16(outbytes, &weight);
    return 0;
}
