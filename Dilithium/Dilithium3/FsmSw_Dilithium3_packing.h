...
/**********************************************************************************************************************/
void FsmSw_Dilithium3_pack_pk(uint8 pk[FSMSW_DILITHIUM3_CRYPTO_PUBLICKEYBYTES], const uint8 rho[SEEDBYTES_DILITHIUM],
...
void FsmSw_Dilithium3_pack_sig(uint8 sig[FSMSW_DILITHIUM3_CRYPTO_BYTES], const uint8 c[CTILDEBYTES_DILITHIUM3],
                               const polyvecl_D3 *z, const polyveck_D3 *h);

void FsmSw_Dilithium3_unpack_pk(uint8 rho[SEEDBYTES_DILITHIUM], polyveck_D3 *t1,
...
sint8 FsmSw_Dilithium3_unpack_sig(uint8 c[CTILDEBYTES_DILITHIUM3], polyvecl_D3 *z, polyveck_D3 *h,
