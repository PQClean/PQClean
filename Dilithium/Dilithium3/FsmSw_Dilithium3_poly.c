...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_poly_invntt_tomont
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_poly_pointwise_montgomery
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_poly_make_hint
*
...
uint32 FsmSw_Dilithium3_poly_make_hint(poly_D3 *h, const poly_D3 *a0, const poly_D3 *a1)
{
    ...
    for (i = 0; i < N_DILITHIUM; ++i)
    {
        h->coeffs[i] = (sint32)FsmSw_Dilithium3_make_hint(a0->coeffs[i], a1->coeffs[i]);
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_poly_use_hint
*
...
void FsmSw_Dilithium3_poly_use_hint(poly_D3 *b, const poly_D3 *a, const poly_D3 *h)
{
    ...
    for (i = 0; i < N_DILITHIUM; ++i)
    {
        b->coeffs[i] = FsmSw_Dilithium3_use_hint(a->coeffs[i], (uint32)h->coeffs[i]);
    }
}
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_poly_uniform_eta
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_challenge
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyeta_pack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyeta_unpack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyt1_pack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyt1_unpack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyt0_pack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyt0_unpack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyz_pack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyz_unpack
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Dilithium3_polyw1_pack
*
