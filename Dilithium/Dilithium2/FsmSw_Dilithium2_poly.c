...
void FsmSw_Dilithium2_polyeta_pack(uint8 *r, const poly_D2 *a)
{
    ...
    {
        t[0] = (uint8) (ETA_DILITHIUM2 - (uint8)a->coeffs[8u * i + 0u]);
...
void FsmSw_Dilithium2_polyeta_unpack(poly_D2 *r, const uint8 *a)
{
    ...
    for (i = 0; i < N_DILITHIUM / 8u; ++i)
    {
        r->coeffs[8u * i + 0u] = (sint32)((uint32)((uint32)((uint32)(a[3u * i + 0u]) >> 0) & 7u));
        r->coeffs[8u * i + 1u] = (sint32)((uint32)((uint32)((uint32)(a[3u * i + 0u]) >> 3) & 7u));
        ...
        r->coeffs[8u * i + 0u] = (sint32)ETA_DILITHIUM2 - r->coeffs[8u * i + 0u];
...
void FsmSw_Dilithium2_polyz_pack(uint8 *r, const poly_D2 *a)
{
    ...
    for (i = 0; i < N_DILITHIUM / 4u; ++i)
    {
        t[0] = GAMMA1_DILITHIUM2 - (uint32)a->coeffs[4u * i + 0u];
...
void FsmSw_Dilithium2_polyz_unpack(poly_D2 *r, const uint8 *a)
{
    ...
    for (i = 0; i < N_DILITHIUM / 4u; ++i)
    {
        r->coeffs[4u * i + 0u] = (sint32)a[9u * i + 0u];
        r->coeffs[4u * i + 0u] = (sint32)((uint32)((uint32)r->coeffs[4u * i + 0u] | ((uint32)a[9u * i + 1u] <<  8u)));
        r->coeffs[4u * i + 0u] = (sint32)((uint32)((uint32)r->coeffs[4u * i + 0u] | ((uint32)a[9u * i + 2u] << 16u)));
        r->coeffs[4u * i + 0u] = (sint32)((uint32)((uint32)r->coeffs[4u * i + 0u] & 0x3FFFFu));
        ...
        r->coeffs[4u * i + 0u] = (sint32)((uint32)(GAMMA1_DILITHIUM2 - (uint32)r->coeffs[4u * i + 0u]));
...
void FsmSw_Dilithium2_polyw1_pack(uint8 *r, const poly_D2 *a)
{
    ...
    for (i = 0; i < N_DILITHIUM / 4u; ++i)
    {
        r[3u * i + 0u] = (uint8) ((uint32)a->coeffs[4u * i + 0u]);
        r[3u * i + 0u] = (uint8) ((uint32)((uint32)r[3u * i + 0u] | ((uint32)a->coeffs[4u * i + 1u] << 6u)));
