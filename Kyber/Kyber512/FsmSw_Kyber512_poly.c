...
/**********************************************************************************************************************/
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_compress
*
* Description: Compression and subsequent serialization of a polynomial
*
* Arguments:   -       uint8   *r: pointer to output byte array (of length KYBER512_POLYCOMPRESSEDBYTES)
*              - const poly512 *a: pointer to input polynomial
***********************************************************************************************************************/
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_decompress
*
* Description: De-serialization and subsequent decompression of a polynomial;
*              approximate inverse of FsmSw_Kyber512_poly_compress
*
* Arguments:   -       poly512 *r: pointer to output polynomial
*              - const uint8   *a: pointer to input byte array (of length KYBER512_POLYCOMPRESSEDBYTES bytes)
***********************************************************************************************************************/
void FsmSw_Kyber512_poly_decompress(poly512 *r, const uint8 a[KYBER512_POLYCOMPRESSEDBYTES])
{
    ...
    {
        temp1 = (uint16)a[0] & 15u;
        r->coeffs[2u * i + 0u] = (sint16)(uint16)((((uint32)temp1 * KYBER_Q) + 8u) >> 4u);
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_tobytes
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_frombytes
*
* Description: De-serialization of a polynomial;
*              inverse of FsmSw_Kyber512_poly_tobytes
*
* Arguments:   -       poly512 *r: pointer to output polynomial
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_frommsg
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_tomsg
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_getnoise_eta1
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_getnoise_eta2
*
* Description: Sample a polynomial deterministically from a seed and a nonce,
*              with output polynomial close to centered binomial distribution
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_invntt_tomont
*
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_basemul_montgomery
*
* Description: Multiplication of two polynomials in NTT domain
*
* Arguments:   -       poly512 *r: pointer to output polynomial
*              - const poly512 *a: pointer to first input polynomial
*              - const poly512 *b: pointer to second input polynomial
***********************************************************************************************************************/
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_tomont
*
* Description: Inplace conversion of all coefficients of a polynomial
*              from normal domain to Montgomery domain
*
* Arguments:   - poly512 *r: pointer to input/output polynomial
***********************************************************************************************************************/
...
/***********************************************************************************************************************
* Name:        FsmSw_Kyber512_poly_reduce
*
